...
import time
from _1_config import (num_tasks, static_inputs, TEST_INDICES, NUM_ATTEMPTS, TOL, MAXITER, GAUSSIAN_STD,
                       NUM_ATTEMPTS_SLOW, TOL_SLOW, MAXITER_SLOW, GAUSSIAN_STD_SLOW, SLOW_POINT_CUT_OFF)
